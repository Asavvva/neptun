...
def drawing(u, v, t, lon = lon_grid, lat = lat_grid, save=False):
    ...
    if save:
        try:
            plt.savefig(f'/mnt/hippocamp/asavin/Plume_description/wind/pictures_East/{t.year}/{t.date()}.png')
        except:
            os.makedirs(f'/mnt/hippocamp/asavin/Plume_description/wind/pictures_East/{t.year}')
            plt.savefig(f'/mnt/hippocamp/asavin/Plume_description/wind/pictures_East/{t.year}/{t.date()}.png')
