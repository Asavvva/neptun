...
def load_file(filename, lon_min_era5 = 55, lon_max_era5 = 105, lat_min_era5 = 70, lat_max_era5 = 80):
    ...
    k= 6
    N = u10.shape[0]
    u10 = u10.reshape(N//k, k, *u10.shape[1:]).mean(axis=1)
    v10 = v10.reshape(N//k, k, *v10.shape[1:]).mean(axis=1)
...
for file in wind_files:
    wind = load_file(file)
    with open(f'/mnt/hippocamp/asavin/data/wind/wind_products_6hrs_arrays_kara_n80_s70_w55_e105/{file[-10:-3]}.pkl', 'wb') as file:
