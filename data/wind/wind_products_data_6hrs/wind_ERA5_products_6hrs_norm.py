...
for file in wind_files:
    ...
    wind = np.stack([u10, v10, r])
    wind = np.transpose(wind, (1, 0, 2, 3))

    with open(f'/mnt/hippocamp/asavin/data/wind/wind_arrays_6hrs_kara_norm_n80_s70_w55_e105/{file[-11:]}', 'wb') as file:
